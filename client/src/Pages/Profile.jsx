  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <button
        ...
        className="text-green-700 w-full uppercase text-lg border p-3"
      >
        Show Listings
      </button>
          ...
          {userListings.map((listing) => (
            ...
            >
              ...
              <Link
                ...
                className="text-slate-700 font-semibold flex-1 hover:underline p-1 truncate"
              >
                <p>{listing.name}</p>
              </Link>
              <div className="flex flex-col items-center gap-1">
                <button
                  ...
                  className=" text-red-700 uppercase border"
                >
                  Delete
                </button>
