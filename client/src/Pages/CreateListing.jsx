        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <p className="text-red-700 text-sm">{imageUploadError && imageUploadError}</p>
          {
            formData.imageUrls.length > 0 && formData.imageUrls.map((url, index) => (
              ...
              <img src={url} alt="listing image" className="rounded-lg w-20 h-20 object-cover" />
          ...
          <button disabled={loading || uploading} className="p-3 rounded-lg bg-slate-700 text-white uppercase hover:opacity-90 disabled:opacity-80">
