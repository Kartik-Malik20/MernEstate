    ...
    <header className=" bg-slate-200 shadow-md">
      <div className="flex justify-between max-w-6xl mx-auto p-3">
        ...
        <h1 className="font-bold text-sm sm:text-xl flex flex-wrap">
          <span className="text-slate-500">Eazy</span>
        ...
        <ul className="flex gap-4">
            ...
            <Link to="/profile">
              {currentUser ? (<img className="rounded-full w-8 h-8 object-cover" src={currentUser.avatar} alt="profile" />) :
              <li className="inline text-slate-700 hover:underline cursor-pointer">Sign Up</li>}
              </Link>
